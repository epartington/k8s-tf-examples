## **Complete List of Outbound Calls from Gateway to Management Plane**
...
| Endpoint | Method | Purpose |
|----------|--------|---------|
| `/v1/organisation/{orgId}/resync` | POST | Resync usage/budget data to management plane |
| `/v1/organisation/{orgId}/sync/{timestamp}` | GET | Sync cache invalidations from management plane |
