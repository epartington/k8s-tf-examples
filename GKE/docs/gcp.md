...
3. (Optional) Configure log path format using `LOG_STORE_FILE_PATH_FORMAT`. See [Log Object Path Format](/docs/product/enterprise-offering/components#log-object-path-format) for details.
